...
class _ConnexionScreenState extends State<ConnexionScreen> {
          ...
          return LayoutBuilder(
            builder: (context, constraints) {
              ...
              return Container(
                ...
                height: MediaQuery.of(context).size.height, // Assurer que le conteneur prend toute la hauteur
  ...
  Widget _buildDesktopLayout(BuildContext context, ConnexionState state) {
    return Row(
      ...
      children: [
        ...
        // Formulaire moderne
        _buildFormContainer(context, state),
      ],
    );
  }

  Widget _buildMobileLayout(BuildContext context, ConnexionState state) {
    return Column(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        // Sur mobile, on peut afficher un logo ou une version réduite de l'image si nécessaire
        // Pour l'instant, on se concentre sur le formulaire
        _buildFormContainer(context, state),
  ...
  Widget _buildFormContainer(BuildContext context, ConnexionState state) {
    return Container(
      width: 480,
                    ...
                    TextButton(
                      ...
                      child: const Text(
                        ...
                        style: TextStyle(
                          ...
                          decorationColor: Color(0xFF1CBF3F),
                        ),
                      ),
                    ),
                  ],
